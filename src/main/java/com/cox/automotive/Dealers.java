...
public class Dealers {
  ...
  // This is a concurrent hash map to allow parallel processing of vehicles being added to the dealer
   ...
   */
  public void updateDealer(String datasetId, Integer dealerId, VehicleAnswer vehicleAnswer) {
    ...
    if (result == null) {
      ...
      final DealersApi dealersApi = new DealersApi();
      try {
